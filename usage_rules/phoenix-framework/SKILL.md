...
description: "Use this skill when working with Phoenix Framework. Consult this when working with the web layer, controllers, views, LiveViews, or routing."
metadata:
...
```sh
mix usage_rules.search_docs "search term" -p phoenix -p phoenix_live_dashboard -p phoenix_live_view -p phoenix_ecto -p phoenix_html -p phoenix_live_reload
```
